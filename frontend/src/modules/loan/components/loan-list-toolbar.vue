<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/loan/new' }" v-if="hasPermissionToCreate && hasPermissionToImport">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new" v-if="hasPermissionToImport"></app-i18n> 
      </el-button>
    </router-link>

     <router-link :to="{ path: '/loan/new4user' }" v-if="hasPermissionToCreate && !hasPermissionToImport">
      <el-button icon="el-icon-fa-plus" type="primary">        
        <app-i18n code="common.new4user" v-if="!hasPermissionToImport"></app-i18n>
      </el-button>
    </router-link>
